...
fun LoginScreen(onLogin: () -> Unit = {}) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.aca), // Gambar latar belakang atas
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.mrdiy), // Gambar logo
                contentDescription = null,
            ...
            Text("HALLOW SELAMAT DATANG", fontSize = 24.sp, color = Color.Black)
        ...
        Column(
            ...
            Row(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    ...
                    Text("Alt", color = Color.Black)
                }
                Image(painter = painterResource(R.drawable.ic_launcher_background), contentDescription = null)
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Image(painter = painterResource(R.drawable.ic_launcher_background), contentDescription = null)
                    Text("Lebah FC", color = Color.Black)
                }
            }
